...
CREATE TABLE tnfclty (
	fc_id INT IDENTITY PRIMARY KEY NOT NULL,
...
CREATE TABLE tnwrhse (
	wh_id INT IDENTITY PRIMARY KEY NOT NULL,
...
CREATE TABLE tntype (
	tp_id INT IDENTITY PRIMARY KEY NOT NULL,
...
CREATE TABLE tnitem (
	it_id INT IDENTITY PRIMARY KEY NOT NULL,
	it_code VARCHAR(50) NOT NULL,
	it_name VARCHAR(50) NOT NULL,
	it_desc VARCHAR(250),
	it_tpid INT FOREIGN KEY REFERENCES tntype(tp_id)
);


CREATE TABLE tnitmflty (
	if_id INT IDENTITY PRIMARY KEY NOT NULL,
	if_fcid INT FOREIGN KEY REFERENCES tnfclty(fc_id),
	if_itid INT FOREIGN KEY REFERENCES tnitem(it_id),
	if_quantity DECIMAL
);

CREATE TABLE tnitmwhs (
	iw_id INT IDENTITY PRIMARY KEY NOT NULL,
	iw_whid INT FOREIGN KEY REFERENCES tnwrhse(wh_id),
	iw_itid INT FOREIGN KEY REFERENCES tnitem(it_id),
	iw_quantity DECIMAL
);
